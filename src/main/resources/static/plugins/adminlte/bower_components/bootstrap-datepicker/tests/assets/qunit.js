...
var QUnit = {
	...
	// Checks that the first two arguments are equal, with an optional messageHistory. Prints out both actual and expected values.
...
extend(QUnit, {
	...
	push: function(result, actual, expected, message) {
		...
		message = '<span class="test-messageHistory">' + message + "</span>";
		var output = message;
		if (!result) {
...
extend(QUnit.constructor.prototype, {
	...
	// log: { result, actual, expected, messageHistory }

package cn.tcmp068.aviation.tools;
...
public class PageUtil<T> {
    ...
    private int pageRecorders;//每页数据条数
    ...
    public PageUtil(List<T> list, int pageRecorders,int page) {
        // 通过对象集，记录总数划分
        init(list, pageRecorders,page);
    }
     ...
     */
    public void init(List<T> list, int pageRecorders,int page) {
